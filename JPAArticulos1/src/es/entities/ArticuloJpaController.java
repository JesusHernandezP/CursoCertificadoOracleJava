...
import es.entities.exceptions.NonexistentEntityException;
import es.entities.exceptions.PreexistingEntityException;
...
public class ArticuloJpaController implements Serializable {
    ...
    public void create(Articulo articulo) throws PreexistingEntityException, Exception {
        ...
        try {
            ...
            if (findArticulo(articulo.getIdprod()) != null) {
